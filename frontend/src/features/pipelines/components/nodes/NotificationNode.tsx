    ...
    >
      ...
      <div className="space-y-1 pt-1 border-t border-slate-800/80 text-[11px]">
        <div className="flex justify-between text-slate-400">
          <span>Recipient:</span>
          <span className="font-mono text-emerald-300 font-medium truncate max-w-[120px]">
            {nodeData.recipient || 'ops@example.com'}
          </span>
        </div>
        <div className="flex justify-between text-slate-400">
          <span>Provider:</span>
          <span className="font-mono text-slate-300">Amazon SES</span>
        </div>
      </div>
